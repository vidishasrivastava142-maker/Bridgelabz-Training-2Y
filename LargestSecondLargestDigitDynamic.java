...
class LargestSecondLargestDigitDynamic {
    public static void main(String[] args) {
        ...
        // Define the initial maximum number of digits
        int maxDigit = 10;
        ...
        while (number != 0) {
            ...
            // Increase the array size when it becomes full
            if (index == maxDigit) {

                // Increase maximum size by 10
                maxDigit += 10;

                // Create a temporary array with the new size
                int[] temp = new int[maxDigit];

                // Copy existing digits into the temporary array
